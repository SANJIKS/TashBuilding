...
admin.site.register([Category, MainCarousel, MainCarouselItem, SizeCarousel, Size, SizeCarouselImage, Footer, Advantage, Unique, UniqueItem, HouseImage, House, HouseSchemeCarousel, HouseImageCarousel, Table, MainImage, MainLSTKhome, Video, BigDescription, ComLSTK, Technologically, Carousel, CarouselItem, VideoItem, Navbar, NavbarItem, Form])
